...
const char  const_DlgUpdate[]    PROGMEM = "* AKTUALIZUJĘ *";
const char const_DlgNextion[]    PROGMEM = "* NEXTION *";
const char const_getWeather[]    PROGMEM = "";
const char  const_waitForSD[]    PROGMEM = "INDEKSOWANIE SD";
const char  const_DlgSleeping[]    PROGMEM = "USYPIANIE";

const char        apNameTxt[]    PROGMEM = "PUNKT DOSTĘPU";
...
#else
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 odczuwalna: %.1f\011C \007 ciśnienie: %d hPa \007 wilgotność: %d%% \007 wiatr: %.1f km/h [%s]";
#else
